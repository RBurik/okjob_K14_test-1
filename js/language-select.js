...
var $languageInformation = `<div class="language-information"><h5 class="language-information-title">Повар</h5>
...
<button class="delete-button language-delete">
...
$('.language-add').on("click", function() {
    ...
    $('.language-wrapper li').on("click", function() {
        ...
        if (!$(this).parent().parent().parent().next().hasClass('language-information')) {
            $('.language-wrapper:last').append($languageInformation);
